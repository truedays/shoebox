...
# Ray@eboundhost.com
#
#  Temporarily enables root (password based) login for a period of 
userset $sleeptime time.
...
#   * Continues even if user places in backgroud and logs out 
(re-secures after $sleeptime)
#
# Bugs:
#   * Will not run if sshd_config is not already set securely to 
"without-password"
#
# ToDo:
#   * Test for cases of multiple lines beginning with PermitRoot...  
Unknown results
#
